...
<div class="user-form" style="float: left; width: 100%;"> 
	<div class="row">
		<form action="<?php echo $GLOBALS['ep_dynamic_url']; ?>register" method="post" class="col s12">
		  <div class="row">
			...
			<div class="input-field col s12">
			  <input  id="username" name="password" id="password" type="password" class="validate" value="">
			...
			<!-- <div id=captcha>
		   		...
		   		<a href=""><img style="padding-top: 15px;padding-left: 15px; height: 64px;width: auto;" src="<?php //echo $GLOBALS['ep_dynamic_url'];?>view/images/refresh.png"> </a>
		   </div> -->
			<!-- <div class="input-field col s12">
			  <input id="captcha" name="captcha" type="text" class="validate" value="<?php// if(isset($_POST['location'])) { echo $post['location']; } ?>">
	...
	<a href='<?php echo $GLOBALS['ep_dynamic_url']; ?>'> Quay lại </a>
</div>
</div>
