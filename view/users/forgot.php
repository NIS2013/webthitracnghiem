...
<center><h3 style="float: left; width: 100%;padding: 0 25px;"> Quên mật khẩu </h3></center>
	...
	<div class="row">
		<form action="<?php echo $GLOBALS['ep_dynamic_url']; ?>login/forgot" method="post" class="col s12">
		  ...
		  <div class="input-field col s12">
			  ...
			  <label for="email">Email phục hồi</label>
			</div>
			<div class="input-field col s12">
				<button class="btn waves-effect waves-light light-blue darken-4" type="submit" style="margin-top: 20px;">Phục hồi
